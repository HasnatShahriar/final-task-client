        ...
        <footer className="bg-gray-800 text-gray-300 py-10">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col items-center md:items-start">
                    <h2 className="text-lg font-bold text-white">TrueBond</h2>
                    <p className="mt-2 text-sm text-gray-400">
                        Connecting hearts across the world. We believe in finding true love.
                    </p>
                </div>
                ...
                <div className="flex flex-col items-center md:items-start">
                    ...
                    <p className="mt-2 text-sm text-gray-400">Email: support@truebond.com</p>
                    <p className="mt-1 text-sm text-gray-400">Phone: +1 234 567 890</p>
